PhpOrient\Protocols\Binary\Operations\RecordCreate
===============
...
#### $record_type
```php
    public integer $record_type = \PhpOrient\Protocols\Common\Constants::RECORD_TYPE_DOCUMENT
```
